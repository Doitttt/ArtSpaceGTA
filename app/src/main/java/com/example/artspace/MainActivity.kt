...
private fun ArtSpace() {
    ...
    when (artworkIndex) {
        0 -> {
            artwork = R.drawable.gta_3
            artworkDescription = R.string.gta_3_desc
            artworkName = R.string.gta_3_title
            artworkReleaseYear = R.string.twentyone
            artworkGenre = R.string.author_gta
        }
        1 -> {
            artwork = R.drawable.gta_sa
            artworkDescription = R.string.gta_sa_desc
            artworkName = R.string.gta_sa_title
            artworkReleaseYear = R.string.twentyfour
            artworkGenre = R.string.author_gta
        }
        2 -> {
            artwork = R.drawable.gta_4
            artworkDescription = R.string.gta_4_desc
            artworkName = R.string.gta_4_title
            artworkReleaseYear = R.string.twentyeight
            artworkGenre = R.string.author_gta

        }
        else -> {
            artwork = R.drawable.gta_5
            artworkDescription = R.string.gta_5_desc
            artworkName = R.string.gta_5_title
            artworkReleaseYear = R.string.twentythirdteen
            artworkGenre = R.string.author_gta
        }
    }
